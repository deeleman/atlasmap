(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/http'), require('@angular/forms'), require('rxjs/Observable'), require('rxjs/operator/distinctUntilChanged'), require('rxjs/operator/map'), require('rxjs/BehaviorSubject'), require('rxjs/operator/observeOn'), require('rxjs/operator/scan'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/map'), require('rxjs/Subject'), require('rxjs/add/observable/from'), require('rxjs/add/operator/debounceTime'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/toArray'), require('rxjs/add/operator/toPromise'), require('rxjs/add/observable/forkJoin'), require('@angular/platform-browser')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/http', '@angular/forms', 'rxjs/Observable', 'rxjs/operator/distinctUntilChanged', 'rxjs/operator/map', 'rxjs/BehaviorSubject', 'rxjs/operator/observeOn', 'rxjs/operator/scan', 'rxjs/add/operator/filter', 'rxjs/add/operator/map', 'rxjs/Subject', 'rxjs/add/observable/from', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/toArray', 'rxjs/add/operator/toPromise', 'rxjs/add/observable/forkJoin', '@angular/platform-browser'], factory) :
	(factory((global['atlasmap-data-mapper'] = {}),global.ng.core,global.ng.common,global.ng.http,global.ng.forms,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable,global.ng.platformBrowser));
}(this, (function (exports,core,common,http,forms,Observable,distinctUntilChanged,map,BehaviorSubject,observeOn,scan,filter,map$2,Subject,from,debounceTime,mergeMap,toArray,toPromise,forkJoin,platformBrowser) { 'use strict';
...
var BsDatepickerInputDirective = (function () {
    ...
    BsDatepickerInputDirective.ctorParameters = function () {
        return [
            { type: BsDatepickerComponent, decorators: [{ type: core.Host },] },
            { type: core.Renderer2, },
            { type: core.ElementRef, },
            { type: core.ChangeDetectorRef, },
        ];
...
var BsDaterangepickerInputDirective = (function () {
    ...
    BsDaterangepickerInputDirective.ctorParameters = function () {
        return [
            { type: BsDaterangepickerComponent, decorators: [{ type: core.Host },] },
            { type: core.Renderer2, },
            { type: core.ElementRef, },
            { type: core.ChangeDetectorRef, },
        ];
...
var ProgressDirective = (function () {
    ...
    ProgressDirective.decorators = [
        { type: core.Directive, args: [{ selector: 'bs-progress, [progress]' },] },
    ];
    /** @nocollapse */
...
var MappingManagementService = (function () {
    ...
    function MappingManagementService(http$$1) {
        this.http = http$$1;
        this.mappingUpdatedSource = new Subject.Subject();
        this.mappingUpdated$ = this.mappingUpdatedSource.asObservable();
        this.saveMappingSource = new Subject.Subject();
        this.saveMappingOutput$ = this.saveMappingSource.asObservable();
        this.mappingSelectionRequiredSource = new Subject.Subject();
    ...
    MappingManagementService.prototype.fetchMappings = function (mappingFileNames, mappingDefinition) {
        ...
        return new Observable.Observable(function (observer) {
            ...
            Observable.Observable.forkJoin(operations).subscribe(function (data) {
                if (!data) {
                    observer.next(false);
                    observer.complete();
                    return;
...
var InitializationService = (function () {
    ...
    function InitializationService(documentService, mappingService, errorService) {
        ...
        this.systemInitializedSource = new Subject.Subject();
        this.systemInitialized$ = this.systemInitializedSource.asObservable();
        this.initializationStatusChangedSource = new Subject.Subject();
...
DataMapperAppExampleHostComponent.propDecorators = {
    'dataMapperComponent': [{ type: core.ViewChild, args: ['dataMapperComponent',] },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
DataMapperAppComponent.propDecorators = {
    'lineMachine': [{ type: core.ViewChild, args: ['lineMachine',] },],
    'errorPanel': [{ type: core.ViewChild, args: ['errorPanel',] },],
    'modalWindow': [{ type: core.ViewChild, args: ['modalWindow',] },],
    'docDefInput': [{ type: core.ViewChild, args: ['docDefInput',] },],
    'docDefOutput': [{ type: core.ViewChild, args: ['docDefOutput',] },],
    'mappingDetailComponent': [{ type: core.ViewChild, args: ['mappingDetailComponent',] },],
    'toolbarComponent': [{ type: core.ViewChild, args: ['toolbarComponent',] },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
ModalWindowComponent.propDecorators = {
    ...
    'nestedComponentType': [{ type: core.Input },],
    'nestedComponentInitializedCallback': [{ type: core.Input },],
    'okButtonHandler': [{ type: core.Input },],
    'cancelButtonHandler': [{ type: core.Input },],
    'cfg': [{ type: core.Input },],
    'myTarget': [{ type: core.ViewChildren, args: ['dyn_target', { read: core.ViewContainerRef },] },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
ToolbarComponent.propDecorators = {
    'cfg': [{ type: core.Input },],
    'lineMachine': [{ type: core.Input },],
    'modalWindow': [{ type: core.Input },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
LineMachineComponent.propDecorators = {
    'cfg': [{ type: core.Input },],
    'docDefInput': [{ type: core.Input },],
    'docDefOutput': [{ type: core.Input },],
    'lineMachineElement': [{ type: core.ViewChild, args: ['lineMachineElement',] },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
var FieldEditComponent = (function () {
    function FieldEditComponent() {
        ...
        this.namespaces = [];
        this.docDef = null;
        this.dataSource = Observable.Observable.create(function (observer) {
...
DocumentDefinitionComponent.propDecorators = {
    'cfg': [{ type: core.Input },],
    'isSource': [{ type: core.Input },],
    'lineMachine': [{ type: core.Input },],
    'modalWindow': [{ type: core.Input },],
    'documentDefinitionElement': [{ type: core.ViewChild, args: ['documentDefinitionElement',] },],
    'fieldComponents': [{ type: core.ViewChildren, args: ['fieldDetail',] },],
    'docElements': [{ type: core.ViewChildren, args: ['docDetail',] },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
DocumentFieldDetailComponent.propDecorators = {
    ...
    'lineMachine': [{ type: core.Input },],
    'modalWindow': [{ type: core.Input },],
    'fieldDetailElement': [{ type: core.ViewChild, args: ['fieldDetailElement',] },],
    'fieldComponents': [{ type: core.ViewChildren, args: ['fieldDetail',] },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
MappingSelectionSectionComponent.propDecorators = {
    'outputNumber': [{ type: core.Input },],
    'mapping': [{ type: core.Input },],
    'selectedCallback': [{ type: core.Input },],
    'selected': [{ type: core.Input },],
    'selectedFieldIsSource': [{ type: core.Input },],
    'parentComponent': [{ type: core.Input },],
    'isOddRow': [{ type: core.Input },],
};
...
MappingSelectionComponent.propDecorators = {
    'sectionComponents': [{ type: core.ViewChildren, args: ['mappingSection',] },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
MappingPairDetailComponent.propDecorators = {
    ...
    'fieldPair': [{ type: core.Input },],
    'modalWindow': [{ type: core.Input },],
    'sourcesHeader': [{ type: core.ViewChild, args: ['sourcesHeader',] },],
    'actionsHeader': [{ type: core.ViewChild, args: ['actionsHeader',] },],
    'targetsHeader': [{ type: core.ViewChild, args: ['targetsHeader',] },],
};
...
LookupTableComponent.propDecorators = {
    'outputSelects': [{ type: core.ViewChildren, args: ['outputSelect',] },],
};
/*
    Copyright (C) 2017 Red Hat, Inc.
...
exports.DataMapperModule = DataMapperModule;
exports.ɵw = CollapsableHeaderComponent;
exports.ɵv = ConstantFieldEditComponent;
exports.ɵl = DataMapperErrorComponent;
exports.ɵh = DataMapperAppExampleHostComponent;
exports.ɵa = DocumentDefinitionComponent;
exports.ɵk = DocumentFieldDetailComponent;
exports.ɵs = FieldEditComponent;
exports.ɵn = LineMachineComponent;
exports.ɵr = LookupTableComponent;
exports.ɵc = CollectionMappingComponent;
exports.ɵe = MappingDetailComponent;
exports.ɵd = MappingPairDetailComponent;
exports.ɵb = SimpleMappingComponent;
exports.ɵi = MappingFieldActionComponent;
exports.ɵj = MappingFieldDetailComponent;
exports.ɵy = MappingListComponent;
exports.ɵx = MappingListFieldComponent;
exports.ɵp = MappingSelectionComponent;
exports.ɵo = MappingSelectionSectionComponent;
exports.ɵm = TransitionSelectionComponent;
exports.ɵf = EmptyModalBodyComponent;
exports.ɵg = ModalWindowComponent;
exports.ɵt = NamespaceEditComponent;
exports.ɵz = NamespaceListComponent;
exports.ɵu = PropertyFieldEditComponent;
exports.ɵba = TemplateEditComponent;
exports.ɵq = ToolbarComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=atlasmap-data-mapper.umd.js.map
